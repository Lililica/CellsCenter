...
struct Graphe {
    ...
    bool useOctagon     = false; // Flag to control whether to use the octagon for energy calculation
    ...
    std::vector<std::array<Point, 8>>    allOctagons;      // List of octagons for the points
